...
var symbolicNames = [ null, "DOT", "COMMA", "ASSIGN", "NAME", "NUMBER", 
                      "EMAIL", "PASSWORD", "TEXT", "INT", "SPACE", "WS" ];
...
registerParser.INT = 9;
registerParser.SPACE = 10;
registerParser.WS = 11;
...
registerParser.prototype.register = function() {
    ...
    try {
        ...
        localctx.name = localctx._username.output
        this.state = 14;
        ...
        localctx.number = localctx._usernumber.output
        this.state = 19;
        this.match(registerParser.COMMA);
        this.state = 20;
        ...
        localctx.email = localctx._useremail.output
        this.state = 24;
        this.match(registerParser.COMMA);
        this.state = 25;
        ...
        localctx.password = localctx._userpassword.output
    } catch (re) {
...
registerParser.prototype.username = function() {
    ...
    try {
        ...
        localctx.output =  (localctx._TEXT===null ? null : localctx._TEXT.text)
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
